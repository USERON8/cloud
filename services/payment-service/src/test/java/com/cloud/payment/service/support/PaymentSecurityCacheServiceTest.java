...
class PaymentSecurityCacheServiceTest {
  ...
  @InjectMocks private PaymentSecurityCacheService paymentSecurityCacheService;
  ...
  void cacheStatus_finalStatus_ignored() {
    ...
    verify(hashOperations, never())
        .putAll(any(), org.mockito.ArgumentMatchers.<Map<Object, Object>>any());
  }
  ...
  void cacheStatus_nonFinal_writesHash() {
    ...
    verify(hashOperations)
        .putAll(eq("pay:status:pay2"), org.mockito.ArgumentMatchers.<Map<Object, Object>>any());
