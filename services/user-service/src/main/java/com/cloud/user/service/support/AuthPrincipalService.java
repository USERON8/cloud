...
public class AuthPrincipalService {
    ...
    public Long createPrincipal(AuthPrincipalDTO authPrincipalDTO) {
        ...
        User existing = authPrincipalDTO.getId() == null ? null : userMapper.selectById(authPrincipalDTO.getId());
        ...
        List<String> roles = authPrincipalDTO.getRoles() == null || authPrincipalDTO.getRoles().isEmpty()
                ? List.of("ROLE_USER")
    ...
    public Boolean updatePrincipal(AuthPrincipalDTO authPrincipalDTO) {
        ...
        if (authPrincipalDTO.getStatus() != null) {
            ...
            update.setEnabled(resolveEnabled(authPrincipalDTO.getEnabled(), authPrincipalDTO.getStatus(), existing.getEnabled()));
