...
public class MinioServiceImpl implements MinioService {
    ...
    private static final List<String> SUPPORTED_CERT_TYPES = Arrays.asList(
    ...
    public String uploadBusinessLicense(Long merchantId, MultipartFile file) {
        ...
        try {
            ...
            String objectName = String.format("cert/license/%d/%s%s", merchantId, UUID.randomUUID(), extension);
            try (InputStream inputStream = file.getInputStream()) {
                minioClient.putObject(
                        PutObjectArgs.builder()
