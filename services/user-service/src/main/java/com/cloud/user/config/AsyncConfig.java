...
public class AsyncConfig extends BaseAsyncConfig {
  ...
  public Executor userQueryExecutor() {
    ...
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor(
            "userQueryExecutor", Math.max(4, processors), processors * 3, 300, 60, "user-query-");
    executor.initialize();
  ...
  public Executor userOperationExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("userOperationExecutor", 4, 16, 500, 60, "user-operation-");
    executor.initialize();
  ...
  public Executor userStatisticsExecutor() {
    ...
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor(
            "userStatisticsExecutor", processors, processors + 1, 100, 60, "user-statistics-");
    executor.initialize();
