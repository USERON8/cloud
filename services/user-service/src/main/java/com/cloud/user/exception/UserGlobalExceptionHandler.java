...
public class UserGlobalExceptionHandler extends com.cloud.common.exception.GlobalExceptionHandler {
  ...
  public Result<String> handleDuplicateKeyException(
    ...
    log.warn(
        "Duplicate key conflict - uri: {}, message: {}", request.getRequestURI(), e.getMessage());
  ...
  public Result<String> handleUserServiceException(
      UserServiceException e, HttpServletRequest request) {
    log.warn(
        "User service exception - uri: {}, type: {}, message: {}",
  ...
  public Result<String> handleAdminException(AdminException e, HttpServletRequest request) {
    log.warn(
        "Admin service exception - uri: {}, type: {}, message: {}",
        request.getRequestURI(),
        e.getClass().getSimpleName(),
        e.getMessage());
  ...
  public Result<String> handleMerchantException(MerchantException e, HttpServletRequest request) {
    log.warn(
        "Merchant service exception - uri: {}, type: {}, message: {}",
        request.getRequestURI(),
        e.getClass().getSimpleName(),
        e.getMessage());
