...
public interface UserNotificationService {
  ...
  CompletableFuture<Boolean> sendStatusChangeNotificationAsync(
      Long userId, Integer newStatus, String reason);

  CompletableFuture<Boolean> sendBatchNotificationAsync(
      java.util.List<Long> userIds, String title, String content);
