...
class MerchantServiceImplTest {
  ...
  void createMerchant_success_callsRemoteSync() {
    ...
    LambdaQueryChainWrapper<Merchant> queryWrapper =
    ...
    when(merchantMapper.insert(org.mockito.ArgumentMatchers.<Merchant>any()))
        .thenAnswer(
            invocation -> {
    ...
    when(authPrincipalService.getRoleCodesByUserId(anyLong()))
        .thenReturn(java.util.List.of("ROLE_MERCHANT"));
