...
public class OAuth2AuthenticationSuccessHandler implements AuthenticationSuccessHandler {
  ...
  public void onAuthenticationSuccess(
    ...
    try {
      AuthorizationRequestDTO authorizationRequest =
          authorizationRequestSessionService.consume(request);
      ...
      AuthorizationSessionResponseDTO sessionResponse =
          authorizationCodeFlowService.createAuthorizationSession(
  ...
  private void handleError(
    ...
    String message =
        URLEncoder.encode(
            errorMessage == null ? "OAuth2 login failed" : errorMessage, StandardCharsets.UTF_8);
