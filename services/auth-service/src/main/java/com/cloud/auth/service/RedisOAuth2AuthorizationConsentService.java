...
public class RedisOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {
  ...
  public void save(@NonNull OAuth2AuthorizationConsent authorizationConsent) {
    ...
    Assert.hasText(
        authorizationConsent.getRegisteredClientId(), "registeredClientId cannot be empty");
    ...
    try {
      ...
      log.debug(
          "OAuth2 authorization consent saved: clientId={}, principalName={}, authorities={}",
      ...
      log.error(
          "Failed to save OAuth2 authorization consent to Redis: clientId={}, principalName={}",
          authorizationConsent.getRegisteredClientId(),
          authorizationConsent.getPrincipalName(),
          e);
  ...
  public void remove(@NonNull OAuth2AuthorizationConsent authorizationConsent) {
    ...
    try {
      ...
      if (deleted) {
        log.debug(
            "OAuth2 authorization consent removed: clientId={}, principalName={}",
            authorizationConsent.getRegisteredClientId(),
            authorizationConsent.getPrincipalName());
      } else {
        log.warn(
            "OAuth2 authorization consent not found for removal: clientId={}, principalName={}",
            authorizationConsent.getRegisteredClientId(),
            authorizationConsent.getPrincipalName());
      }
      ...
      log.error(
          "Failed to remove OAuth2 authorization consent from Redis: clientId={}, principalName={}",
          authorizationConsent.getRegisteredClientId(),
          authorizationConsent.getPrincipalName(),
          e);
  ...
  public OAuth2AuthorizationConsent findById(
    ...
    try {
      ...
      if (consent instanceof OAuth2AuthorizationConsent authorizationConsent) {
        log.debug(
            "OAuth2 authorization consent found: clientId={}, principalName={}, authorities={}",
            registeredClientId,
            principalName,
            authorizationConsent.getAuthorities());
      ...
      log.debug(
          "OAuth2 authorization consent not found: clientId={}, principalName={}",
          registeredClientId,
          principalName);
      return null;
      ...
      log.error(
          "Failed to find OAuth2 authorization consent from Redis: clientId={}, principalName={}",
          registeredClientId,
          principalName,
          e);
  ...
  public long getConsentCount() {
    try {
      return RedisKeyScanSupport.countKeysByPattern(redisTemplate, CONSENT_KEY_PREFIX + "*");
    } catch (Exception e) {
