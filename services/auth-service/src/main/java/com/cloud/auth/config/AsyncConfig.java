...
public class AsyncConfig extends BaseAsyncConfig {
  ...
  public Executor authAsyncExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("authAsyncExecutor", 3, 8, 300, 60, "auth-async-");
    executor.initialize();
  ...
  public Executor authTokenExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("authTokenExecutor", 4, 16, 500, 60, "auth-token-");
    executor.initialize();
  ...
  public Executor authSecurityLogExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("authSecurityLogExecutor", 2, 6, 500, 60, "auth-security-log-");
    executor.initialize();
  ...
  public Executor authOAuth2Executor() {
    ...
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor(
            "authOAuth2Executor", processors * 2, processors * 4, 300, 60, "auth-oauth2-");
    executor.initialize();
  ...
  public Executor authSessionExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("authSessionExecutor", 2, 5, 200, 60, "auth-session-");
    executor.initialize();
