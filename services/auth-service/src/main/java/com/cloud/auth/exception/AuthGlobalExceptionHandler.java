...
public class AuthGlobalExceptionHandler extends com.cloud.common.exception.GlobalExceptionHandler {
  ...
  public Result<String> handleOAuth2AuthenticationException(
    ...
    log.warn(
        "OAuth2 - uri: {}, errorCode: {}, errorMessage: {}",
        request.getRequestURI(),
        errorCode,
        errorMessage);
  ...
  public Result<String> handleJwtEncodingException(
      org.springframework.security.oauth2.jwt.JwtEncodingException e, HttpServletRequest request) {
  ...
  public Result<String> handleJwtValidationException(
      org.springframework.security.oauth2.jwt.JwtValidationException e,
  ...
  public Result<String> handleDisabledException(
      org.springframework.security.authentication.DisabledException e, HttpServletRequest request) {
    log.warn("?- uri: {}, message: {}", request.getRequestURI(), e.getMessage());
    return Result.error(ResultCode.USER_DISABLED);
  }

  @ExceptionHandler(org.springframework.security.authentication.LockedException.class)
  public Result<String> handleLockedException(
      org.springframework.security.authentication.LockedException e, HttpServletRequest request) {
    log.warn("?- uri: {}, message: {}", request.getRequestURI(), e.getMessage());
  ...
  public Result<String> handleCredentialsExpiredException(
  ...
  public Result<String> handleAccountExpiredException(
      org.springframework.security.authentication.AccountExpiredException e,
      HttpServletRequest request) {
    log.warn("?- uri: {}, message: {}", request.getRequestURI(), e.getMessage());
