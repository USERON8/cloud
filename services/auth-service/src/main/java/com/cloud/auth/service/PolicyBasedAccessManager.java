...
public class PolicyBasedAccessManager {
  ...
  public boolean checkAccess(
      Authentication authentication, String resource, String action, Map<String, Object> context) {
  ...
  private boolean checkMerchantAccess(
      Long merchantId, String resource, String action, Map<String, Object> context) {
  ...
  private boolean checkUserAccess(
      Long userId, String resource, String action, Map<String, Object> context) {
    return switch (resource) {
  ...
  private boolean checkMerchantProductAccess(
      Long merchantId, String action, Map<String, Object> context) {
    Long productId = (Long) context.get("productId");
    return productId != null;
  }

  private boolean checkMerchantOrderAccess(
      Long merchantId, String action, Map<String, Object> context) {
