...
public final class RedisKeyHelper {
    ...
    public static long countKeysByPattern(RedisTemplate<String, Object> redisTemplate, String pattern) {
        return scanKeys(redisTemplate, pattern).size();
    }

    public static Map<String, Long> batchTtlSeconds(RedisTemplate<String, Object> redisTemplate, Set<String> keys) {
