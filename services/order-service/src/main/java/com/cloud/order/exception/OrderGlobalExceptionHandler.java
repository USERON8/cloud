...
public class OrderGlobalExceptionHandler extends com.cloud.common.exception.GlobalExceptionHandler {
  ...
  public Result<String> handleOrderServiceException(
      OrderServiceException e, HttpServletRequest request) {
    log.warn(
        "Order service exception: uri={}, type={}, message={}",
  ...
  public Result<String> handleOrderBusinessException(
      OrderBusinessException e, HttpServletRequest request) {
    log.warn(
        "Order business exception: uri={}, message={}", request.getRequestURI(), e.getMessage());
    return Result.error(e.getCode(), "Order request failed");
  }

  @ExceptionHandler(InsufficientStockException.class)
  public Result<String> handleInsufficientStockException(
      InsufficientStockException e, HttpServletRequest request) {
    log.warn(
        "Insufficient stock: uri={}, productId={}, message={}",
        request.getRequestURI(),
        e.getProductId(),
        e.getMessage());
  ...
  public Result<String> handleConcurrentModificationException(
      java.util.ConcurrentModificationException e, HttpServletRequest request) {
    log.warn(
        "Concurrent modification: uri={}, message={}", request.getRequestURI(), e.getMessage());
    return Result.error(ResultCode.SYSTEM_BUSY, "Concurrent request conflict, please retry");
  }

  @ExceptionHandler(RuntimeException.class)
  public Result<String> handleWrappedRuntimeException(
      RuntimeException e, HttpServletRequest request) {
    BusinessException businessException = unwrapBusinessException(e);
    if (businessException != null) {
      log.warn(
          "Wrapped business exception: uri={}, type={}, code={}, message={}",
          request.getRequestURI(),
          e.getClass().getSimpleName(),
    ...
    log.error(
        "Unhandled runtime exception - uri: {}, type: {}",
        request.getRequestURI(),
        e.getClass().getSimpleName(),
        e);
  ...
  public Result<String> handleHttpClientErrorException(
      org.springframework.web.client.HttpClientErrorException e, HttpServletRequest request) {
    log.warn(
        "Remote client error: uri={}, status={}, message={}",
        request.getRequestURI(),
        e.getStatusCode(),
        e.getMessage());
  ...
  public Result<String> handleHttpServerErrorException(
      org.springframework.web.client.HttpServerErrorException e, HttpServletRequest request) {
    log.error(
        "Remote server error: uri={}, status={}, message={}",
        request.getRequestURI(),
        e.getStatusCode(),
        e.getMessage(),
        e);
