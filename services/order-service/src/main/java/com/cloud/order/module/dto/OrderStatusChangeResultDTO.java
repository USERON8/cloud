...
public class OrderStatusChangeResultDTO {
  ...
  public static OrderStatusChangeResultDTO success(
  ...
  public static OrderStatusChangeResultDTO batchSuccess(
      String operationType,
      List<Long> orderIds,
      Integer beforeStatus,
      Integer afterStatus,
  ...
  public static OrderStatusChangeResultDTO failure(
      String operationType, Long orderId, String errorCode, String errorMessage, Long operatorId) {
    return OrderStatusChangeResultDTO.builder()
        .success(false)
        .operationType(operationType)
        .orderId(orderId)
  ...
  public static OrderStatusChangeResultDTO batchFailure(
      String operationType,
      List<Long> orderIds,
      String errorCode,
      String errorMessage,
