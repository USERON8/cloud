...
public class AsyncConfig extends BaseAsyncConfig {
  ...
  public Executor orderAsyncExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("orderAsyncExecutor", 4, 8, 400, 60, "order-async-");
    executor.initialize();
  ...
  public Executor orderLogExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("orderLogExecutor", 1, 3, 1000, 60, "order-log-");
    executor.initialize();
  ...
  public Executor orderNotificationExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("orderNotificationExecutor", 2, 4, 300, 60, "order-notification-");
    executor.initialize();
  ...
  @ConditionalOnProperty(
      name = "order.statistics.enabled",
      havingValue = "true",
      matchIfMissing = true)
  public Executor orderStatisticsExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("orderStatisticsExecutor", 1, 2, 1200, 60, "order-statistics-");
    executor.initialize();
  ...
  public Executor orderPaymentExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("orderPaymentExecutor", 4, 16, 500, 60, "order-payment-");
    executor.initialize();
