...
class OrderCreateTccActionTest {
  ...
  @Mock private OrderTccLogMapper orderTccLogMapper;

  @Mock private OrderAggregateCacheService orderAggregateCacheService;

  @Mock private OrderTimeoutMessageProducer orderTimeoutMessageProducer;
  ...
  private void injectProductDubboApi(OrderCreateTccAction target, ProductDubboApi api) {
    try {
      java.lang.reflect.Field field =
          OrderCreateTccAction.class.getDeclaredField("productDubboApi");
