...
class OrderRefundSagaServiceTest {
    ...
    @InjectMocks
    private OrderRefundSagaService orderRefundSagaService;
    ...
    void applyRefund_statusMismatch_throws() {
        ...
        assertThatThrownBy(() -> orderRefundSagaService.applyRefund(Map.of(
                "afterSaleId", 1L,
    ...
    void createRefund_success_callsRemote() {
        ...
        orderRefundSagaService.createRefund(Map.of(
                "refundNo", "R1",
                "paymentNo", "P1",
                "afterSaleNo", "A1",
    ...
    void cancelRefund_updatesAfterSaleAndCache() {
        ...
        orderRefundSagaService.cancelRefund(Map.of(
                "afterSaleId", 2L,
