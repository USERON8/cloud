...
class OrderPlacementServiceImplTest {
  ...
  @Mock private OrderCreateTccAction orderCreateTccAction;

  @Mock private StockReserveTccRemoteService stockReserveTccRemoteService;

  @InjectMocks private OrderPlacementServiceImpl orderPlacementService;
  ...
  void createOrder_success_reservesStock() {
    ...
    when(stockReserveTccRemoteService.tryReserve(org.mockito.ArgumentMatchers.any()))
        .thenReturn(true);
