...
class OrderServiceImplTest {
    ...
    @Mock
    private OrderRefundSagaCoordinator orderRefundSagaCoordinator;
    ...
    @Mock
    private OrderShippedMessageProducer orderShippedMessageProducer;

    @Mock
    private OrderAutoReceiveMessageProducer orderAutoReceiveMessageProducer;
    ...
    void advanceSubOrderStatusCancelShouldReleaseReservedStock() {
        ...
        Map<Long, Integer> quantities = captor.getAllValues().stream()
                .collect(java.util.stream.Collectors.toMap(
                        StockOperateCommandDTO::getSkuId,
                        StockOperateCommandDTO::getQuantity
                ));
