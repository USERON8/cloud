...
class StockReserveTccRemoteServiceTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(stockReserveTccRemoteService, "stockReserveTccApi", stockReserveTccApi);
    }
    ...
    void tryReserve_businessException_passthrough() {
        ...
        assertThatThrownBy(() -> stockReserveTccRemoteService.tryReserve(command))
                .isSameAs(original);
