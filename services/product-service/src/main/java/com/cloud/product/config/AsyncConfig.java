...
public class AsyncConfig extends BaseAsyncConfig {
  ...
  public Executor productAsyncExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("productAsyncExecutor", 2, 4, 500, 60, "product-async-");
    executor.initialize();
  ...
  public Executor productLogExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("productLogExecutor", 1, 2, 1000, 60, "product-log-");
    executor.initialize();
  ...
  @ConditionalOnProperty(
      name = "product.statistics.enabled",
      havingValue = "true",
      matchIfMissing = true)
  public Executor productStatisticsExecutor() {
    ThreadPoolTaskExecutor executor =
        createConfiguredExecutor("productStatisticsExecutor", 2, 4, 500, 60, "product-statistics-");
    executor.initialize();
