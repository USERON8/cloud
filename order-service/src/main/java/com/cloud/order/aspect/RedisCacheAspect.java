...
import com.cloud.order.annotation.RedisCacheEvict;
import com.cloud.order.annotation.RedisCachePut;
import com.cloud.order.annotation.RedisCacheable;
...
public class RedisCacheAspect {
    ...
    private String buildRedisKey(String cacheName, String key) {
        return "order-cache:" + cacheName + ":" + key;
    }
