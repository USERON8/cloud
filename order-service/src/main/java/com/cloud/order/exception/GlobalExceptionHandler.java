...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handleOrderServiceException(OrderServiceException e) {
    ...
    public Result<Void> handleOrderStatusException(OrderStatusException e) {
        log.warn("订单状态错误: {}", e.getMessage());
        return Result.error(e.getCode(), e.getMessage());
    }
