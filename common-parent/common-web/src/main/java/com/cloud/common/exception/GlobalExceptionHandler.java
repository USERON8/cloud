...
public class GlobalExceptionHandler {
  ...
  public Result<String> handleUsernameNotFoundException(
  ...
  public Result<String> handleResourceNotFoundException(
  ...
  public Result<String> handlePermissionException(
      PermissionException e, HttpServletRequest request) {
    log.warn(
        "Permission exception - uri: {}, message: {}", request.getRequestURI(), e.getMessage());
    return Result.error(e.getCode(), e.getMessage());
  }

  @ExceptionHandler(ConcurrencyException.class)
  public Result<String> handleConcurrencyException(
      ConcurrencyException e, HttpServletRequest request) {
    log.warn(
        "Concurrency exception - uri: {}, message: {}", request.getRequestURI(), e.getMessage());
    return Result.error(e.getCode(), e.getMessage());
  }
  ...
  public Result<String> handleHandlerMethodValidationException(
  ...
  public Result<String> handleDataAccessException(
      org.springframework.dao.DataAccessException e, HttpServletRequest request) {
    log.error(
        "Data access exception - uri: {}, message: {}", request.getRequestURI(), e.getMessage(), e);
  ...
  public Result<String> handleJsonProcessingException(
      com.fasterxml.jackson.core.JsonProcessingException e, HttpServletRequest request) {
    log.warn(
        "Invalid JSON payload - uri: {}, message: {}", request.getRequestURI(), e.getMessage());
  ...
  public Result<String> handleHttpMessageNotReadableException(
      ...
      HttpServletRequest request) {
    log.warn(
        "Unreadable HTTP message - uri: {}, message: {}", request.getRequestURI(), e.getMessage());
