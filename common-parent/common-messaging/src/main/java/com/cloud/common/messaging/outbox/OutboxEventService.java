...
public class OutboxEventService {
  ...
  public OutboxEvent enqueue(
      String aggregateType, String aggregateId, String eventType, String payload, String eventId) {
    ...
    String safeEventId =
        StringUtils.hasText(eventId) ? eventId.trim() : UUID.randomUUID().toString();
