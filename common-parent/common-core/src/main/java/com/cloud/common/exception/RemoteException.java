...
public class RemoteException extends BaseException {
    ...
    public static RemoteException rejected(ResultCode resultCode, String target, Throwable cause) {
        return new RemoteException(
                resultCode, target + " rejected", cause, RemoteFailType.REJECTED);
    }

    public static RemoteException providerError(ResultCode resultCode, String target, Throwable cause) {
        return new RemoteException(
