...
public class Result<T> implements Serializable {
  ...
  public static <T> Result<T> badRequest() {
    return new Result<>(
        ResultCode.BAD_REQUEST.getCode(), ResultCode.BAD_REQUEST.getMessage(), null);
  }
  ...
  public static <T> Result<T> systemError() {
    return new Result<>(
        ResultCode.SYSTEM_ERROR.getCode(), ResultCode.SYSTEM_ERROR.getMessage(), null);
  }
  ...
  public static <T> Result<T> businessError() {
    return new Result<>(
        ResultCode.BUSINESS_ERROR.getCode(), ResultCode.BUSINESS_ERROR.getMessage(), null);
  }
  ...
  public static <T> Result<T> paramError() {
    return new Result<>(
        ResultCode.PARAM_ERROR.getCode(), ResultCode.PARAM_ERROR.getMessage(), null);
  }
