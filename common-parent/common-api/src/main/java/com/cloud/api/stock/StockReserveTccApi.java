...
public interface StockReserveTccApi {
    ...
    @TwoPhaseBusinessAction(name = "stockReserveTcc", commitMethod = "commitReserve", rollbackMethod = "cancelReserve")
    boolean tryReserve(BusinessActionContext actionContext,
