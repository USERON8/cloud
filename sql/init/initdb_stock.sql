...
(
  ...
  COLLATE = utf8mb4_unicode_ci COMMENT ='库存主表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='入库记录表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='出库记录表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='库存操作日志表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='库存盘点表';

-- ==================== 初始化数据 ====================

-- 插入测试库存数据
INSERT INTO `stock` (`product_id`, `product_name`, `stock_quantity`, `frozen_quantity`, `stock_status`,
                     `low_stock_threshold`)
VALUES (1, '华为Mate 60 Pro', 100, 0, 1, 20),
...
-- 插入测试入库记录
INSERT INTO `stock_in` (`product_id`, `quantity`)
VALUES (1, 100),
       (2, 150),
       (3, 80),
       (4, 120),
...
-- 插入测试出库记录
INSERT INTO `stock_out` (`product_id`, `order_id`, `quantity`)
VALUES (2, 1001, 10),
       (3, 1002, 5);

-- 插入测试库存日志
INSERT INTO `stock_log` (`product_id`, `product_name`, `operation_type`, `quantity_before`, `quantity_after`,
                         `quantity_change`, `remark`, `operate_time`, `operator_name`)
VALUES (1, '华为Mate 60 Pro', 'IN', 0, 100, 100, '初始入库', NOW(), '系统管理员'),
...
-- 插入测试盘点记录
INSERT INTO `stock_count` (`count_no`, `product_id`, `product_name`, `expected_quantity`, `actual_quantity`,
                           `difference`, `status`, `operator_name`, `count_time`)
VALUES ('COUNT2025011600001', 1, '华为Mate 60 Pro', 100, 98, -2, 'PENDING', '仓库管理员', NOW()),
