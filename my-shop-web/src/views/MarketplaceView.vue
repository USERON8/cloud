  ...
  <div class="market-page">
    ...
    <section class="shop-grid">
      <article
        ...
        :enter="{ opacity: 1, y: 0, transition: { duration: 0.25, delay: Math.min(index * 0.04, 0.2) } }"
    ...
    <section class="product-grid">
      <article
        ...
        v-motion
        :initial="{ opacity: 0, y: 10 }"
        :enter="{ opacity: 1, y: 0, transition: { duration: 0.25, delay: Math.min(index * 0.03, 0.2) } }"
      >
