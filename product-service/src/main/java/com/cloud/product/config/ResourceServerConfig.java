    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api/product/internal/**").hasAuthority("SCOPE_internal_api")
                        
                        // 商品查询接口需要read scope
                        .requestMatchers("/api/product/query/**").hasAnyAuthority("SCOPE_read", "SCOPE_user.read")
                        
                        // 商品管理接口需要write scope
                        .requestMatchers("/api/product/manage/**").hasAnyAuthority("SCOPE_write", "SCOPE_user.write")
