...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handleProductServiceException(ProductServiceException e) {
        log.error("商品服务异常: {}", e.getMessage(), e);
        return Result.error(e.getCode(), e.getMessage());
    }
    ...
    public Result<Void> handleProductNotFoundException(ProductNotFoundException e) {
    ...
    public Result<Void> handleProductStatusException(ProductStatusException e) {
        log.warn("商品状态错误: {}", e.getMessage());
        return Result.error(e.getCode(), e.getMessage());
    }
    ...
    public Result<Void> handleCategoryNotFoundException(CategoryNotFoundException e) {
        log.warn("商品分类不存在: {}", e.getMessage());
        return Result.error(e.getCode(), e.getMessage());
    }
