...
public interface ProductService extends IService<Product> {
    ...
    Boolean updateProduct(Long id, ProductRequestDTO requestDTO)
            throws ProductServiceException.ProductNotFoundException, ProductServiceException;
    ...
    List<ProductVO> getProductsByCategoryId(Long categoryId, Integer status)
            throws ProductServiceException.CategoryNotFoundException;
    ...
    Boolean batchEnableProducts(List<Long> ids)
            throws ProductServiceException.ProductNotFoundException,
            ProductServiceException.ProductStatusException,
            ProductServiceException;

    Boolean batchDisableProducts(List<Long> ids)
            throws ProductServiceException.ProductNotFoundException,
            ProductServiceException.ProductStatusException,
            ProductServiceException;
    ...
    Boolean increaseStock(Long id, Integer amount)
            throws ProductServiceException.ProductNotFoundException, ProductServiceException;

    Boolean decreaseStock(Long id, Integer amount)
            throws ProductServiceException.ProductNotFoundException, ProductServiceException;

    Boolean checkStock(Long id, Integer amount)
            throws ProductServiceException.ProductNotFoundException, ProductServiceException;
