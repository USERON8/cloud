...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handleAdminServiceException(AdminServiceException e) {
        log.error("管理服务异常: {}", e.getMessage(), e);
        return Result.error(e.getCode(), e.getMessage());
    }
    ...
    public Result<Void> handleAdminNotFoundException(AdminNotFoundException e) {
        log.warn("管理员不存在: {}", e.getMessage());
        return Result.error(e.getCode(), e.getMessage());
    }
    ...
    public Result<Void> handleAdminPermissionException(AdminPermissionException e) {
        log.warn("管理员权限不足: {}", e.getMessage());
        return Result.error(e.getCode(), e.getMessage());
    }
    ...
    public Result<Void> handleSystemConfigException(SystemConfigException e) {
        log.error("系统配置错误: {}", e.getMessage(), e);
        return Result.error(e.getCode(), e.getMessage());
    }
