...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handleUserServiceException(UserServiceException e) {
     ...
     * 处理地址权限异常
     */
    @ExceptionHandler(AddressPermissionException.class)
    public Result<Void> handleAddressPermissionException(AddressPermissionException e) {
        log.warn("地址权限错误: {}", e.getMessage());
        return Result.error(e.getCode(), e.getMessage());
    }
