...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handlePaymentServiceException(PaymentServiceException e) {
    ...
    public Result<Void> handlePaymentNotFoundException(PaymentNotFoundException e) {
        log.warn("支付记录不存在: {}", e.getMessage());
        return Result.error(e.getCode(), e.getMessage());
    }
    ...
    public Result<Void> handlePaymentStatusException(PaymentStatusException e) {
        log.warn("支付状态错误: {}", e.getMessage());
        return Result.error(e.getCode(), e.getMessage());
    }
    ...
    public Result<Void> handleInsufficientBalanceException(InsufficientBalanceException e) {
