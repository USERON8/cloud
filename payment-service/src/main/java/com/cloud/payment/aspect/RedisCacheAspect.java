...
import com.cloud.payment.annotation.RedisCacheEvict;
import com.cloud.payment.annotation.RedisCachePut;
import com.cloud.payment.annotation.RedisCacheable;
...
public class RedisCacheAspect {
    ...
    private String buildRedisKey(String cacheName, String key) {
        return "payment-cache:" + cacheName + ":" + key;
    }
